...
\begin{minipage}{0.48\textwidth}
\centering
\includegraphics[height=0.444444444444444444444444444444444444444444444Sample seen through Front Optical Port in Liquid Strand Burner. Linear Regression of Propellant Recorded through this Optical Access Window.}
\label{fig4}
\end{minipage}
\end{figure}
...
\centering
\includegraphics[width=1.0\linewidth]{Figure_5.jpg}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.75\textwidth]{Single_Burn_Rate_Results.png}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.75\textwidth]{Dual_Burn_Rate_Results.png}
