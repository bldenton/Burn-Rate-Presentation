...
\begin{minipage}{0.48\textwidth}
\centering
\includegraphics[width=0.95\linewidth]{Figure_3.jpg}
...
\begin{minipage}{0.48\textwidth}
\centering
\includegraphics[height=0.4\linewidth]{Figure_4.jpg}
\caption{Sample seen through Front Optical Port in Liquid Strand Burner. Linear Regression of Propellant Recorded through this Optical Access Window.}
\label{fig4}
\end{minipage}
\end{figure}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.5\textwidth]{Figure_5.jpg}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.5\textwidth]{Figure_6.jpg}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.5\textwidth]{Single_Burn_Rate_Results.png}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.5\textwidth]{Dual_Burn_Rate_Results.png}
